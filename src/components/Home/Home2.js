          ...
          <Col md={8} className='home-about-description'>
            ...
            <p className='home-about-body'>
              ...
              <i>
                ...
                modern cutting edge technology like{' '}
                <b className='purple'>React js and node Js.</b>
              </i>
              <br />
              <br />
              Whenever possible, I also apply my passion for Extracting Data
              with <b className='purple'>Python frameworks Scrapy</b> and &nbsp;
              <i>
        ...
        <Row>
          <Col md={12} className='home-about-social'>
            ...
            <ul className='home-about-social-links'>
              ...
              <li className='social-icons'>
                <a
                  href='https://twitter.com/mohsanch545'
                  target='_blank'
                  rel='noreferrer'
                  className='icon-colour  home-social-icons'
                >
              ...
              <li className='social-icons'>
                <a
                  href='https://www.linkedin.com/in/m-mohsin-iqbal/'
                  target='_blank'
                  rel='noreferrer'
                  className='icon-colour  home-social-icons'
                >
